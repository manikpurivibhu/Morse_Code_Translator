...
#still needs some upgrades on python dictionary for chars like '\'
#look into that
...
def main():
	...
	message = str(input("Enter your script(English) for encoding : "))
	result = encrypt(message.upper())
	print (result)

	message = str(input("Enter Morse Code for decoding : "))
